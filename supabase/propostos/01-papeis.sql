...
comment on table app_usuario is
  'Papéis do FPV Campo. diretoria=Lucas/Rafael · gestao=engenharia/medição · cadastro=esteira (Brendah) · almox=João · campo=encarregados e equipes de emergência.';
...
insert into app_usuario (email, nome, papel, executores, fiscais, pode_priorizar, pode_financeiro, obs) values
  ...
  ('nicolas@fpv.app',      'Nicolas',       'gestao',    '{Nicolas}', '{}', true,  false, 'engenharia · despacho'),
  ...
  ('brendah@fpv.app',      'Brendah',       'cadastro',  '{}', '{}', false, false, 'cadastros · esteira'),
  -- ALMOXARIFADO: manda no material, não manda na O.S. de campo
  ('joao@fpv.app',         'João',          'almox',     '{}', '{}', false, false, 'almoxarife'),
  -- CAMPO · corretiva (painel filtrado por EXECUTOR)
  ('gilson@fpv.app',       'Gilson',        'campo',     '{Gilson}',         '{}', false, false, 'corretiva'),
  ('carlosalberto@fpv.app','Carlos Alberto','campo',     '{"Carlos Alberto"}','{}', false, false, 'corretiva'),
  -- CAMPO · emergência (login é da EQUIPE; painel por ZONA do fiscal)
  ('emergencia1@fpv.app',  'Equipe Leandro','campo',     '{Wellington,Leandro}', '{Wellington}', false, false, 'emergência · zona Wellington'),
  ('emergencia2@fpv.app',  'Equipe Renato', 'campo',     '{Renato,Patrick}',     '{Renato}',     false, false, 'emergência · zona Renato')
